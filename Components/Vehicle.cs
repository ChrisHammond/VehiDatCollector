...
{
    [TableName("VehiDataCollector_Vehicles")]
    //setup the primary key for table
    [PrimaryKey("VehicleId", AutoIncrement = true)]
    //configure caching using PetaPoco
    [Cacheable("Vehicles", CacheItemPriority.Default, 20)]
    ...
    class Vehicle
    {
        ...
        ///<summary>
        /// A string with the name of the VehicleName
        ///</summary>
        ...
        ///</summary>
        public int VehicleOwnerUserId { get; set; }
