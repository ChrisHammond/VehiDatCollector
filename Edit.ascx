<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Edit.ascx.cs" Inherits="Christoc.Modules.VehiDataCollector.Edit" %>
...
<div class="dnnForm dnnEditBasicSettings" id="dnnEditBasicSettings">
    ...
    <fieldset>
        ...
        <div class="dnnFormItem">
            ...
            <asp:DropDownList ID="ddlVehicleOwnerUserId" runat="server" />
        </div>
    </fieldset>
</div>
